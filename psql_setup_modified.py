...
cur.execute("DROP TABLE IF EXISTS equalproducts CASCADE")
cur.execute("DROP TABLE IF EXISTS segmentPopulairProduct CASCADE")
...
#All recommendation engine-related tables

cur.execute("""CREATE TABLE equalProducts
                (prodid VARCHAR PRIMARY KEY,
                 equalid VARCHAR,
                 FOREIGN KEY (prodid) REFERENCES products (id));""")

cur.execute("""CREATE TABLE segmentPopulairProduct
                (segment VARCHAR,
                 prodid VARCHAR PRIMARY KEY,
                 FOREIGN KEY (prodid) REFERENCES products (id));""")
